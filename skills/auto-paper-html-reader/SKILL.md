...
6. Write the HTML report.
   ...
   - Embed the main technical-route figure directly in the technical-roadmap section and explain each visible component of the figure. This must be a tight crop of the figure itself, not a page render. If a tight crop cannot be created, omit the image and explain the limitation in prose.
