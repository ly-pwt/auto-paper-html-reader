...
- Make the roadmap image zoomable: wrap the cropped image in an `<a class="figure-zoom" href="same-relative-image-path" target="_blank" rel="noopener">` and place it inside a `<figure class="figure-panel roadmap-figure">`. The in-page preview should stay compact, while the linked original image lets the user inspect fine details.
...
6. Write the HTML report.
   ...
   - Use this structure for the roadmap image so it is compact on the page and zoomable for details:
     `<figure class="figure-panel roadmap-figure"><a class="figure-zoom" href="sources/<paper-slug>/figures/<roadmap-crop>.png" target="_blank" rel="noopener"><img src="sources/<paper-slug>/figures/<roadmap-crop>.png" alt="..."></a>...</figure>`.
